    ...
    return (
        ...
        >
            ...
            <div className="p-4 relative z-10 w-full text-center">
                ...
                <h1
                    className="mt-30 mb-7 md:mt-20 text-5xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400"
                >Master the Art of Music</h1>
                <p
                    className="mt-4 font-normal text-base 
                            md:text-xl text-neutral-300
                          max-w-xl mx-auto"
                ...
                <div className="mt-4">
                    <Link href={"/courses"}>
                        <Button
                            ...
                            dark:text-white border-neutral-200 
